import { g as useRuntimeConfig, k as useRequestEvent } from './server.mjs';
import { z as withLeadingSlash, n as joinURL, y as withoutTrailingSlash, A as withBase, v as hash } from '../runtime.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-B0ny1_PG.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-KI92nEIE.mjs.map

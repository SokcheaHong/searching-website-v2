import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, defineComponent, provide, createElementBlock, defineAsyncComponent, h, computed, unref, shallowReactive, Suspense, nextTick, Fragment, Transition, useSSRContext, mergeProps, withCtx, createVNode, createApp, effectScope, reactive, getCurrentScope, isReactive, toRaw, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, onScopeDispose, shallowRef, isReadonly, toRefs, markRaw, isShallow } from 'vue';
import { $ as $fetch$1, w as withQuery, l as hasProtocol, m as isScriptProtocol, n as joinURL, h as createError$1, o as defu, p as sanitizeStatusCode, q as createHooks, t as toRouteMatcher, r as createRouter$1 } from '../runtime.mjs';
...
function useServerSeoMeta(input, options) {
  return useSeoMeta(input, { ...{}, mode: "server" });
}
...
const _routes = [
  {
    name: "document-id",
    path: "/document/:id()",
    component: () => import('./_id_-BxKpRp5M.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-d3pkD3i8.mjs').then((m) => m.default || m)
  },
  {
    name: "laws-register",
    path: "/laws-register",
    component: () => import('./index-Bocq0wVu.mjs').then((m) => m.default || m)
  },
  {
    name: "news",
    path: "/news",
    component: () => import('./index-BemHbavn.mjs').then((m) => m.default || m)
  },
  {
    name: "result",
    path: "/result",
    component: () => import('./index-BWDKpfXg.mjs').then((m) => m.default || m)
  },
  {
    name: "update-laws",
    path: "/update-laws",
    component: () => import('./index-CaeZwWOz.mjs').then((m) => m.default || m)
  }
];
...
function onPrehydrate(callback, key) {
  ...
  if (vm && key) {
    (_a = vm.attrs)[PREHYDRATE_ATTR_KEY] || (_a[PREHYDRATE_ATTR_KEY] = "");
    key = ":" + key + ":";
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-BYnC8wOT.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-BeodUJ9s.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-C7v5up__.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-OiTmmJWQ.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-CX7d2T0y.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-BZaoUB5y.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-CUzleriR.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-D2jsaHTI.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-BXqVwyCQ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-D49rRkV9.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-BwKhNLAZ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-sRDGYGj3.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-wwH1qoWi.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-BK80NWe4.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: () => import('./default-BPkmhyXh.mjs').then((m) => m.default || m)
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useServerSeoMeta({
      ...
      description: "គេហទំព័រនេះ ត្រូវបានបង្កើតឡើងដើម្បីចងក្រងទិន្នន័យលិខិតបទដ្ឋានគតិយុត្តក្នុងក្របខណ្ឌវិស័យរៀបចំដែនដី នគរូបនីយកម្ម និងសំណង់។",
      ogDescription: "គេហទំព័រនេះ ត្រូវបានបង្កើតឡើងដើម្បីចងក្រងទិន្នន័យលិខិតបទដ្ឋានគតិយុត្តក្នុងក្របខណ្ឌវិស័យរៀបចំដែនដី នគរូបនីយកម្ម និងសំណង់។",
      ogType: "website",
      ogUrl: config.public.webBaseUrl,
      ogImage: config.public.webBaseUrl + "/mlmupc-logo.ico",
      ogSiteName: "ក្រសូងរៀបចំដែនដី នគរូបនីយកម្ម និងសំណង់",
      robots: { index: true, noimageindex: true, follow: true }
    });
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BgkpqCcT.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-C3VOHI8B.mjs').then((r) => r.default || r));
...
export { __nuxt_component_4 as _, useRoute as a, useSeoMeta as b, useServerSeoMeta as c, useRouter as d, entry$1 as default, useRequestFetch as e, fetchDefaults as f, useRuntimeConfig as g, useNuxtApp as h, defineStore as i, useState as j, useRequestEvent as k, asyncDataDefaults as l, createError as m, nuxtLinkDefaults as n, onPrehydrate as o, navigateTo as p, useHead as u };

...
import { j as useState, g as useRuntimeConfig } from './server.mjs';
import { v as hash } from '../runtime.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-KI92nEIE.mjs';
import { u as useContentPreview } from './preview-BTfJuqZV.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-B0ny1_PG.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-C7v5up__.mjs.map

      ...
      <a href="/" class="w-full"
        ><div class="flex items-center gap-1 md:gap-2">
          ...
          <div class="grid gap-1">
            <p class="header_site_title text-[11px] sm:text-lg md:text-xl text-white">
              ក្រសួងរៀបចំដែនដី នគរូបនីយកម្ម និងសំណង់
            </p>
            <p class="text-[8.25px] sm:text-[13.5px] md:text-[15px] text-white">
              Ministry of Land Management, Urban Planning and Construction
            </p>
          </div>
        </div></a
      >
      <nav class="hidden lg:flex items-center text-[#051a53] gap-3">
        <a
          href="https://web.facebook.com/mlmupc.pressteam"
          target="_blank"
          title="Facebook"
          ><svg
          ...
          >
            ...
            ></path></svg></a
        ><a
          href="https://www.youtube.com/@MLMUPC_KH"
          target="_blank"
          title="YouTube"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            ...
            ></path></svg></a
        ><a
          href="https://t.me/MLMUPCofCambodia"
          target="_blank"
          title="Telegram"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            ...
            ></path></svg></a
        ><a
          href="https://www.tiktok.com/@mlmupc_kh?is_from_webapp=1&amp;sender_device=pc"
          target="_blank"
          title="TikTok"
        >
          <svg

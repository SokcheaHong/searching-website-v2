  ...
  <template v-if="pending">
    <div class="w-[90%] m-auto h-screen flex item-center justify-center">
      <div class="w-full h-screen">
        <div class="block h-20 w-full mx-auto custom_skeleton" />
        <div class="flex h-screen w-full mt-1">
          <div class="grid w-[30%] grid-cols-1 gap-1">
            <div class="block h-full w-full mx-auto custom_skeleton" />
            <div class="block h-full w-full mx-auto custom_skeleton" />
            <div class="block h-full w-full mx-auto custom_skeleton" />
            <div class="block h-full w-full mx-auto custom_skeleton" />
            <div class="block h-full w-full mx-auto custom_skeleton" />
          ...
          <div class="block h-full w-[70%] mx-auto custom_skeleton ml-1" />
        </div>
      </div>
    </div>
  </template>
  <template v-else-if="!pending && item.content">
    <div
      data-aos="fade-down"
        ...
        >
          ...
          <div role="tabpanel" class="tab-content active w-full p-2 pt-4">
            <div class="folder-tree-wrapper">
              <div v-if="pending && heading"></div>
              <ul v-else class="folder-tree" ref="folderTree">
                <li v-for="(h1, index) in heading" :key="index">
          ...
          <div role="tabpanel" class="tab-content pt-4 __details p-2">
            ...
            <div>
              <!-- <vue-pdf-app style="height: 100vh;width: 100%;" :pdf="''"></vue-pdf-app> -->
            </div>
          </div>
        </div>
      </div>
